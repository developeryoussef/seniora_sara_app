...
import '../../controllers/quiz_paper/home_work_controller.dart';
...
class HomeWorkOverviewScreen extends GetView<HomeWorkController> {
  const HomeWorkOverviewScreen({Key? key}) : super(key: key);

  static const String routeName = '/homeworkoverview';
