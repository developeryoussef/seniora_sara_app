...
import '../../controllers/quiz_paper/homeworkscontroller.dart';
...
class HomeWorkScreenScreen extends GetView<MyDrawerController> {
  const HomeWorkScreenScreen({Key? key}) : super(key: key);


  @override
  Widget build(BuildContext context) {
    HomeWorkPapersController _quizePprContoller = Get.put(HomeWorkPapersController());
